...
namespace Web.Services
{
    public class BasketViewModelService : IBasketViewModelService
    {
        ...
        private string GetOrCreateBuyerId()
        {
            ...
            _httpContextAccessor.HttpContext.Response.Cookies.Append(Constants.BASKET_COOKIENAME, newGuid, new CookieOptions() { Expires = DateTime.Now.AddYears(1), IsEssential = true });
            return newGuid;
